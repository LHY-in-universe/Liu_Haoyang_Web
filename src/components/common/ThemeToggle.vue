...
[data-theme="dark"] .theme-toggle {
  ...
  box-shadow: 0 4px 15px rgba(240, 147, 251, 0.5), 0 0 30px rgba(240, 147, 251, 0.3);
}
...
[data-theme="dark"] .theme-toggle:hover {
  box-shadow: 0 8px 25px rgba(240, 147, 251, 0.5), 0 0 40px rgba(240, 147, 251, 0.3);
}
...
[data-theme="dark"] .theme-toggle:focus-visible {
  box-shadow: 0 0 0 4px rgba(240, 147, 251, 0.3), 0 4px 15px rgba(240, 147, 251, 0.4);
}
</style>
